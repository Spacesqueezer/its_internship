...
SECRET_KEY = 'django-insecure-1&zzcj#82^%38o+b(oya2ps3b4ifh3p&q%5x45dzz#wq(ee)8h'
...
INSTALLED_APPS = [
    ...
    'integration_utils',
    'b24app',  # приложение для работы с битрикс24
]
...
ROOT_URLCONF = 'its_internship.urls'
...
WSGI_APPLICATION = 'its_internship.wsgi.application'
